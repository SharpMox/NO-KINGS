...
A Godot 4 mobile game built by autonomous agents under Noodle. The agent stack includes a fork of GitNexus extended to understand Godot files; the fork-specific terms live in their own subsection below.
