...
## to each tile's base colour. AMOUNT is the peak offset per channel (0.12 =
## ±12% value; Max picked 0.12 on 2026-09-26, dialled down from 0.15 at the
## finer 0.9 frequency); 0 renders exactly COL_LIGHT/COL_DARK, i.e. the flat
## board.
