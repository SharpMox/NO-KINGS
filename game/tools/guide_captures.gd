...
const SHOTS := [
	...
	{"name": "kings-overview", "file": "game.png",
		...
		"rect": Rect2(40, 265, 400, 275)},
	{"name": "clock", "file": "game.png",
		"flags": ["--scenario-name", "Movement & drag", "--show-screen", "board"],
		"rect": Rect2(140, 0, 200, 60)},
