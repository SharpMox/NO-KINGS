...
HEADLESS_TESTS="rules save cloud_save assets waves kings endless armies scores history settings gold clock shop \
	...
	menu_continue menu_keyboard sign_in board_draw bomb_highlight mass en_passant banners ads capture_paths theme board_anims hud_anims ui_anim casualties scene_fade s4_polish"
