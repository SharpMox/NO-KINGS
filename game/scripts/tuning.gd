...
## to each tile's base colour. AMOUNT is the peak offset per channel (0.05 =
## ±5% value); 0 renders exactly COL_LIGHT/COL_DARK, i.e. the flat board.
