...
(async () => {
  ...
  ok(await page.locator('.art-row .badge:text-is("REWORK")').count() === 22, '22 REWORK badges');
  ok(await page.locator('.art-row .badge:text-is("BASIC")').count() === 23, '23 BASIC badges');
